            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Hero(
                    tag: 'doctor_info_$doctorId',
                    child: BlocBuilder<DoctorProfileCubit, DoctorProfileState>(
                      builder: (context, state) {
                        if (state is DoctorProfileLoaded) {
                          return DoctorInfoContainer(
                            doctorId: doctorId,
                            doctorName: state.doctorProfileModel.name ?? '',
                            specialization:
                                state.doctorProfileModel.specialization ?? '',
                            address: state.doctorProfileModel.address ?? '',
                            phone: state.doctorProfileModel.phone ?? '',
                            imageUrl:
                                state.doctorProfileModel.image?.toString() ??
                                    '',
                            isFavorite:
                                false, // TODO: Implement favorite functionality
                            onFavoritePressed: () {
                        ...
                        child: InkWell(
                          onTap: () {
                            context.read<LocationCubit>().checkAndSaveLocation(
                                isDoctor: true, entityId: doctorId);
                          },
